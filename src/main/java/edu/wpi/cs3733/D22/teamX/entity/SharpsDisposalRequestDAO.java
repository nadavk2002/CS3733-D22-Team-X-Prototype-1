  ...
  public boolean loadCSV() {
    ...
    for (int i = 0; i < sharpsDisposalRequests.size(); i++) {
      try {
        ...
        sharpsDisposalRequest.append(sharpsDisposalRequests.get(i).getPROCTime().toEpochSecond(ZoneOffset.UTC) + ",");
        sharpsDisposalRequest.append(sharpsDisposalRequests.get(i).getDONETime().toEpochSecond(ZoneOffset.UTC) + ",");
