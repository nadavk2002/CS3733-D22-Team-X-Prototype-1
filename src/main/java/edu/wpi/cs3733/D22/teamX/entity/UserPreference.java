...
public class UserPreference {
    ...
    public UserPreference(String username, boolean muteSounds, boolean muteMusic, int volume) {
    ...
    public UserPreference(String username, char muteSounds, char muteMusic, int volume) {
        this.username = username;
        if (muteSounds == 'Y') {
    ...
    public boolean getMuteSounds() {return muteSounds;}
    ...
    public boolean getMuteMusic() {return muteMusic;}
